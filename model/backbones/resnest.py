...
def resnest50(last_stride, **kwargs):
...
def resnest101(last_stride, **kwargs):
...
def resnest200(last_stride, pretrained=False , **kwargs):
    model = ResNet(last_stride, Bottleneck, [3, 24, 36, 3],
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=64, avg_down=True,
                   avd=True, avd_first=False, **kwargs)
    return model

def resnest269(last_stride, pretrained=False , **kwargs):
    model = ResNet(last_stride, Bottleneck, [3, 30, 48, 8],
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=64, avg_down=True,
                   avd=True, avd_first=False, **kwargs)
    return model
